...
def test_techstep_academy_multi_browser():
    ...
    for browser in listofBrowsers:
        ...
        input2_locator_css = browser.find_element_by_css_selector('input[id="ipt2"]')
        ...
        input1_locator_css.send_keys(x)

        print("hi i am browser: " + browser.name)

        print(
            "I have entered 'hey you' in one of the text boxes. Now I will assert that the value of that text box is 'hey you'")
        ...
        assert input2_locator_css.get_attribute(
            "value") == "hey you2", "input2_locator_css text was not expected 'hey you2'"
